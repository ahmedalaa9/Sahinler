    ...
    >
      <div class="container-max section-padding">
        ...
        >
          ...
          >
            Ready to start your next project? Contact our team of manufacturing
            experts and discover how we can bring your vision to life.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-20">
      <div class="container-max section-padding">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <h2
              class="text-3xl font-bold mb-6 text-gray-900 dark:text-white font-heading"
            >
              Send us a Message
            </h2>
